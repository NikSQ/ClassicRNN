...
layout = [n_neurons_1[task_id % 2], n_neurons_2[int(task_id/ 2)]]
#layout = [40, 60]

bn_mode = []
bn_type = ['layer', 'none'][1]
...
hidden_2_config = {'layer_type': 'lstm',
                   ...
                   'regularization': {'mode': 'none', #'zoneout',
...
info_config = {'calc_performance_every': 1,
               'include_pred': False,
               'include_out': False,
               'save_model': {'enabled': True, 'path': '../tr_models/m_model'}}
